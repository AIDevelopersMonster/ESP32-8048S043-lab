...
| 08 | ESP32-8048S043 + LVGL 9 — Six-Card Serial Deck full profile demonstration | https://youtube.com/shorts/0I5JL6jt8e0 | Full demonstration of original App 01: HOME / MEDIA / SYSTEM profile switching, visible reassignment of all six cards, GT911 touch operation and matching `PROFILE:` / `CARD:` commands in Serial/COM. The recording also captures the small presentation-only clipping issue of the original profile label, later targeted by a UX-only refinement. | APP 01 PHYSICAL PASS / PROFILE SWITCHING PASS / SERIAL COMMANDS PASS / STACK STABLE |
...
| 17 Six-Card Serial Deck | original six-card HMI with runtime HOME / MEDIA / SYSTEM reassignment and Serial/COM command output | PUBLISHED / APP 01 PHYSICAL PASS |
