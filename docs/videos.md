...
| 03 | ESP32-8048S043 — Arduino BoardInfo finds 16 MB Flash and 8 MB PSRAM | https://youtube.com/shorts/wELRdRWqlnw | Show the second Arduino `01_BoardInfo` run after changing the PSRAM type/profile, confirming runtime detection of 16 MB flash and 8 MB PSRAM with stable ALIVE lines. | SAMPLE A ARDUINO BOARDINFO PASS / FLASH + PSRAM PASS |
...
| 02 Board passport | esptool/chip/flash/PSRAM identity | PUBLISHED / BOARDINFO PASS |
...
Arduino BoardInfo evidence can support chip/flash/PSRAM/runtime PASS, but it does not replace dedicated display, touch, SD, Wi-Fi/BLE or full BSP validation tests.
