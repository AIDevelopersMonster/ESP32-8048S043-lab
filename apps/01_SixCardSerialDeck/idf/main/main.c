 ...
 *
 * The video demonstrates the current physically validated App 01 firmware:
 * HOME / MEDIA / SYSTEM profile switching, on-screen UI changes,
 * GT911 touch operation and matching Serial/COM commands.
 */
